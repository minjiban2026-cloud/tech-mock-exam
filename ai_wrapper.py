...
- 2점은 ONE-ANCHOR 구조를 우선한다. 첫 번째 고정답은 중심개념이고, 두 번째 고정답은 같은 DB 원문에서 Python이 뽑은 채점근거일 수 있다.
- 2점에서 두 번째 고정답을 별도의 개념명처럼 묻지 않는다. 그 문구가 채점될 수 있도록 같은 중심개념의 이유·근거·오류수정·비교·적용을 요구한다.
