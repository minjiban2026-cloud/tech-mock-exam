...
- 현재 입력에 visual_data가 별도로 제공되지 않았으므로 passage/conditions/tasks에서 '그림', '도식', '그래프', '사진', '아래 그림', '위 그림'처럼 실제 시각자료가 존재한다고 쓰지 않는다. 원자료 문장에 '그려보면서' 같은 표현이 있더라도 새로운 시각자료가 제공된 것처럼 바꾸지 않는다.
- JSON 하나만 출력한다.
{{
 "intro":"...",
 "passage":"...",
