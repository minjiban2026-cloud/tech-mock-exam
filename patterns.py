PATTERNS = [
 {"id":"T2_REL","points":2,"name":"구형 관계형(비사용)","subpoints":[1,1],
  "verbs":["판단","근거/관계"],"calc":False,"weight":0,
  "quality_rule":"첫 판단이 두 번째 답의 근거가 되게 한다. 명칭 두 개 독립 회상 금지."},
 {"id":"T2_ERR","points":2,"name":"규칙도출→적용형","subpoints":[1,1],
  "verbs":["규칙도출","적용계산"],"calc":False,"weight":6,
  "quality_rule":"두 source 사례에서 공통 규칙을 도출한 뒤 그 규칙을 새로운 source 사례에 적용하게 한다. 원문 찾아쓰기·복사 금지."},
 {"id":"T2_CMP","points":2,"name":"구형 비교형(비사용)","subpoints":[1,1],
  "verbs":["비교판단","구분근거"],"calc":False,"weight":0,
  "quality_rule":"두 요소의 차이를 자료에서 판단하고, 그 판단 근거를 연결해 쓰게 한다."},
 {"id":"T2_DATA","points":2,"name":"구형 자료형(비사용)","subpoints":[1,1],
  "verbs":["자료해석","적용판단"],"calc":False,"weight":0,
