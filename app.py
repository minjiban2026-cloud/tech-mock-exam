...
st.caption("배포 버전: R68 · coverage-aware contract type · pair+multi-anchor semantic gate · broken PASS quarantine · rejected fallback 금지 · durable Judge-PASS state")
